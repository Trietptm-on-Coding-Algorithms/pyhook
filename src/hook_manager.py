...
class __HookManager:
	...
	def __init__(self):
		self.func_list = []#hook_function
		self.hook_list = []#hook_context
...
class SocketSendEvent(EventInfo):
	...
	def detail_info(self):
		return [unicode(self.data, "utf-8"),int(self.length)]
...
class HTTPOpenSession(EventInfo):
	...
	def detail_info(self):
		return [str(self.user_agent),str(self.proxy),str(self.bypass)]
...
class HTTPOpenRequestEvent(EventInfo):
	...
	def detail_info(self):
		return [str(self.verb),str(self.path),str(self.version),str(self.referer),str(self.accept_type)]
...
class HttpSendRequestEvent(EventInfo):
	...
	def detail_info(self):
		return [str(self.headers),str(self.optionals)]
...
class ReadFileEvent(EventInfo):
	...
	def detail_info(self):
		return [unicode(self.data, "utf-8"),int(self.size)]
...
class CreateProcessEvent(EventInfo):
	...
	def detail_info(self):
		return [str(self.exe),str(self.cmd),str(self.env),str(self.cur_dir)]
...
class RegCreateEvent(EventInfo):
	...
	def detail_info(self):
		return [str(self.h_key),str(self.sub_key),str(self.cls)]
...
class RegSetEvent(EventInfo):
	...
	def detail_info(self):
		return [str(self.h_key),str(self.name),str(self.data),int(self.size)]
